...
Contains utility functions for data manipulation and file handling. These should
note be accessed directly as they are imported by the Simulation class.
"""
import numpy as np
import os
...
def save_or_show(fig, savefig, fname, out_dir=None, sup_dir=None):
    ...
    out_dir : str
        Path to output directory. Set to ``None`` to auto create a subdirectory
        of `sup_dir`.
    sup_dir : str
